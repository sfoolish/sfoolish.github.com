---
layout: post
title: Native Linux KVM tool 的使用
category: linux
tags: kvm virtualization linux
---

下文的操作都是在 ubuntu12.04 x86_64 下进行，其他 linux 发行版应该也是类似的。关于文件系统的使用详见[linux rootfs.img 文件的使用](/posts/native-linux-kvm-rootfs.html) 。
...
* [domU-x8664-FS.img](http://cloudxy.googlecode.com/files/domU-x86_64-FS.img2.zip)
